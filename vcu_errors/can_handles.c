...
void handleBrakeThrottleMsg(Frame *msg) {
  ...
  Error_Clear(ERROR_FCN_HEARTBEAT_BAD);
  Error_Present(ERROR_FCN_HEARTBEAT_BAD);
}
...
void handleMCVoltageMsg(Frame *msg) {
  ...
  Error_Clear(ERROR_MC_HEARTBEAT_BAD);
  Error_Present(ERROR_MC_HEARTBEAT_BAD);
}
...
void handleBMSHeartbeatMsg(Frame *frame) {
  ...
  Error_Clear(ERROR_BMS_HEARTBEAT_BAD);
  Error_Present(ERROR_BMS_HEARTBEAT_BAD);
}
